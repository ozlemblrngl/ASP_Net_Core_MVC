...
{ 
    ...
    public class Customer
    {
        ...
        public string Password { get; set; }  // Compare("RePassword") de yazabiliriz ancak o zaman RePassword'un ismi değişirse hata almayız bu kodda. nameof ile yaparsak ikinci şifrenin adı değiştiğinde bize doğrusunu yapmak üzere uyarı verir.
